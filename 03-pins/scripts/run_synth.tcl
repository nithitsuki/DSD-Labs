# Create and launch synthesis and implementation.
# Disabling most of the reports - they can be generated later if needed.

open_project ../build/fpga/counter.xpr
...
set_property report_strategy {No Reports} $obj
